...
public class Exercicio9 {
    ...
    public static void heapSort(List<Pokemon> pokedexList) {
        int n = pokedexList.size();

        Pokemon[] tmp = new Pokemon[n + 1];
        for (int i = 0; i < n; i++) {
            tmp[i + 1] = pokedexList.get(i);
        }
        ...
        for (int i = 0; i < n; i++) {
            pokedexList.set(i, tmp[i + 1]);
        }
    }

    public static void construir(Pokemon[] array, int tamHeap) {
    ...
    public static void reconstruir(Pokemon[] array, int tamHeap) {
        int i = 1;
        while (i <= tamHeap / 2) {
    ...
    public static int getMaiorFilho(Pokemon[] array, int i, int tamHeap) {
        int filho;
        comparacoes++;
    ...
    public static int comparePokemon(Pokemon p1, Pokemon p2) {
        comparacoes++;
        if (Double.compare(p1.getHeight(), p2.getHeight()) != 0) {
